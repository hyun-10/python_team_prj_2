...
def app():
  ...
  Data_categorys03 = Category1[4].checkbox("다큐멘터리") 
  Category2 = st.columns(5)
  Data_categorys04 = Category2[0].checkbox("드라마")
  Data_categorys05 = Category2[1].checkbox("멜로")
  Data_categorys06 = Category2[2].checkbox("뮤지컬")
  Data_categorys07 = Category2[3].checkbox("미스터리")
  Data_categorys08 = Category2[4].checkbox("범죄")
  Category3 = st.columns(5)
  Data_categorys09 = Category3[0].checkbox("사극")
  Data_categorys10 = Category3[1].checkbox("서부극")
  Data_categorys11 = Category3[2].checkbox("성인물")
  Data_categorys12 = Category3[3].checkbox("스릴러")
  Data_categorys13 = Category3[4].checkbox("애니메이션")
  Category4 = st.columns(5)
  Data_categorys14 = Category4[0].checkbox("액션")
  Data_categorys15 = Category4[1].checkbox("어드벤처")
  Data_categorys16 = Category4[2].checkbox("전쟁")
  Data_categorys17 = Category4[3].checkbox("코미디")
  Data_categorys18 = Category4[4].checkbox("판타지")
