...
def app():
  ...
  for i in (action,adul,adventure,animation,comedy,crime,documentary,drama,etc,family,fantasy,fear,history,melo,musica,mystery,thriller,war,western):
    df = pd.read_csv(f'db/4p/{}_review_noh_1.csv')
